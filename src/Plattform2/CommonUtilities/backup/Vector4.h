...
public:
	...
	Vector4 operator*(const CU::Matrix44<ObjectType>& aMatrix44) const;
...
template<typename T>
Vector4<T> Vector4<T>::operator*(const CU::Matrix44<T>& aMatrix44) const
{
	Vector4<T> result;
	result.x = (myX * aMatrix44.myMatx[0][0]) + (myY * aMatrix44.myMatx[1][0]) + (myZ * aMatrix44.myMatx[2][0]) + (myW * aMatrix44.myMatx[3][0]);
	result.y = (myX * aMatrix44.myMatx[0][1]) + (myY * aMatrix44.myMatx[1][1]) + (myZ * aMatrix44.myMatx[2][1]) + (myW * aMatrix44.myMatx[3][1]);
	result.z = (myX * aMatrix44.myMatx[0][2]) + (myY * aMatrix44.myMatx[1][2]) + (myZ * aMatrix44.myMatx[2][2]) + (myW * aMatrix44.myMatx[3][2]);
	result.w = (myX * aMatrix44.myMatx[0][3]) + (myY * aMatrix44.myMatx[1][3]) + (myZ * aMatrix44.myMatx[2][3]) + (myW * aMatrix44.myMatx[3][3]);
	return result;
}
