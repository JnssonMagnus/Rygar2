...
namespace tinyxml2
{
	...
	*/
	...
	public:
		...
		static bool	ToWString(const char* str, wchar_t* value);
	...
	*/
	...
	public:
		...
		*/
		...
		XMLError QueryWStringValue(wchar_t* value) const;
	...
	*/
	...
	public:
		...
		*/
		...
		XMLError QueryWStringAttribute(const char* name, wchar_t* value) const			{
			const XMLAttribute* a = FindAttribute(name);
			if (!a) {
				return XML_NO_ATTRIBUTE;
			}
			return a->QueryWStringValue(value);
		}
