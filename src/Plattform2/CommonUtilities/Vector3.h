...
{	
	float x = myX * aMatrix.myMatrix[0] + myY * aMatrix.myMatrix[3] + myZ * aMatrix.myMatrix[6];
	float y = myX * aMatrix.myMatrix[1] + myY * aMatrix.myMatrix[4] + myZ * aMatrix.myMatrix[7];
	float z = myX * aMatrix.myMatrix[2] + myY * aMatrix.myMatrix[5] + myZ * aMatrix.myMatrix[8];
	myX = x;
	myY = y;
	myZ = z;
	return *this;
