...
void Enemy::Init(GameObjectType& aGameObjectType)
{
	...
	myAnimationSet.Init("data/gfx/enemies/orc.png");

	const Vector2<int> frameSize(50, 50);
	myAnimationSet.AddAnimation(eAnimationID::eWalk, 4, frameSize, 10);
	myAnimationSet.AddAnimation(eAnimationID::eIdle, 1, frameSize, 5, { 100, 0 });
	myAnimationSet.AddAnimation(eAnimationID::eFall, 1, frameSize, 5);
	myAnimationSet.AddAnimation(eAnimationID::eJump, 1, frameSize, 5);
	myAnimationSet.AddAnimation(eAnimationID::eDead, 4, frameSize, 7, { 0, 200 }, false);
